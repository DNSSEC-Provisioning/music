...
type InternalConf struct {
	...
	EngineCheck chan common.EngineCheck
	DB          *sql.DB
	MusicDB     *common.MusicDB
	TokViper    *viper.Viper
	DesecFetch  chan common.SignerOp
	DesecUpdate chan common.SignerOp
	DdnsFetch   chan common.SignerOp
	DdnsUpdate  chan common.SignerOp
	Processes   map[string]common.FSM
}
