...
func API_NYI(conf *music.Config) func(w http.ResponseWriter, r *http.Request) {
...
func APIGoAway(conf *music.Config) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		status := 404
...
func APIping(conf *music.Config) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
...
func APItest(conf *music.Config) func(w http.ResponseWriter, r *http.Request) {
...
func APIzone(conf *music.Config) func(w http.ResponseWriter, r *http.Request) {
	mdb := conf.Internal.MusicDB
...
func APIsigner(conf *music.Config) func(w http.ResponseWriter, r *http.Request) {
	mdb := conf.Internal.MusicDB
	return func(w http.ResponseWriter, r *http.Request) {
...
func APIsignergroup(conf *music.Config) func(w http.ResponseWriter, r *http.Request) {
	mdb := conf.Internal.MusicDB
	return func(w http.ResponseWriter, r *http.Request) {
...
func APIprocess(conf *music.Config) func(w http.ResponseWriter, r *http.Request) {
	mdb := conf.Internal.MusicDB
...
func APIshow(conf *music.Config, router *mux.Router) func(w http.ResponseWriter, r *http.Request) {
...
// FIXME: This is the musicd router, contents should be migrated to the agent router
func MusicSetupRouter(conf *music.Config) *mux.Router {
...
// FIXME: This is the musicd APIdispatcher.
func MusicAPIdispatcher(conf *music.Config) error {
	router := MusicSetupRouter(conf)
